...
public class BasicsTopicPlanningAgent {
    ...
    private static final String SYSTEM_PROMPT = """
            You are an expert career assistant. Your task is to analyze the "basics" section of a candidate's career profile and generate a meaningful list of interview topics.
             ...
             reference: An object describing the element linked to the topic.
             
             Allowed properties inside reference:
             
             resumeItemId (string)
             
             spans (array of strings)
             
             startDate (string, format YYYY or YYYY-MM)
             
             endDate (string, format YYYY or YYYY-MM)
             
             resumeItemBeforeId (string)
             
             resumeItemAfterId (string)
